###
# Description: This is the main script that reads configuration files
# 	       fetches sources, parses and submits to elasticsearch
...
parser = argparse.ArgumentParser(description='This is a geenric script for fetching threatelligence data')
...
# Prepare connection to ElasticSearch DB
...
#        		publisher.error('Unable to fetch ' + fetch_url)
        		return #__check_exit()
		drop_file = False
...
#              							print  es_dbid,ip, ccode, longat, result_type, parser_name
